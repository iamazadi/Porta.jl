...
mutable struct Basemap <: Sprite
    ...
    Basemap(scene::GLMakie.LScene, x::ℍ, gauge::Float64, M::Matrix{Float64}, chart::NTuple{4, Float64}, segments::Integer, color::Any; transparency::Bool = false) = begin
...
"""
function update!(basemap::Basemap, x::ℍ, gauge::Float64, M::Matrix{Float64})
    basemap.x = x
    basemap.gauge = gauge
    basemap.M = M
